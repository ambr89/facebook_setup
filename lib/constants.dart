...
const String ANDROID_STRING_FILE = "android/app/src/main/res/values/strings.xml";
...
const String noManifestFileFoundName =
    'File AndroidManifest.xml to get information from was not found in: ' + ANDROID_MANIFEST_FILE;
const String noAndroidStringFileFoundName =
    'File string.xml to get information from was not found in: ' + ANDROID_STRING_FILE;
